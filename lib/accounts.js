...
function getAllAccountFilePaths(installDir) {
    ...
    const candidates = [
        portDir ? path.join(portDir, 'accounts.json') : null,
        portDir ? path.join(portDir, 'cosmic', 'accounts.json') : null,
        portDir ? path.join(portDir, 'CosmicClient-x64', 'accounts.json') : null,
