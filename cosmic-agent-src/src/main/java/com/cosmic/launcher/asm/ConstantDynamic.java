...
public final class ConstantDynamic {
    ...
    public String toString() {
        return ConstantDynamic.stringConcat$0(this.name, this.descriptor, this.bootstrapMethod, Arrays.toString(this.bootstrapMethodArguments));
    }

    private static /* synthetic */ String stringConcat$0(String string, String string2, Handle handle, String string3) {
        return string + " : " + string2 + " " + handle + " " + string3;
    }
}
