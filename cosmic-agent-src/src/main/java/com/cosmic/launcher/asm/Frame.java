        ...
        switch (buffer.charAt(offset)) {
            ...
            case '[': {
                ...
                switch (buffer.charAt(elementDescriptorOffset)) {
                    ...
                    default: {
                        throw new IllegalArgumentException(Frame.stringConcat$0(buffer.substring(elementDescriptorOffset)));
                    }
                }
                return elementDescriptorOffset - offset << 26 | typeValue;
            }
        }
        throw new IllegalArgumentException(Frame.stringConcat$1(buffer.substring(offset)));
    }

    private static /* synthetic */ String stringConcat$0(String string) {
        return "Invalid descriptor fragment: " + string;
    }
        ...
        block0 : switch (opcode) {
            ...
            case 189: {
                ...
                if (arrayElementType.charAt(0) == '[') {
                    this.push(symbolTable, Frame.stringConcat$2(arrayElementType));
                    break;
                }
