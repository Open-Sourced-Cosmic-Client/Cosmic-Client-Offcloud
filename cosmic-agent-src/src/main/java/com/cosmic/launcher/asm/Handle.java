...
public final class Handle {
    ...
    public String toString() {
        return Handle.stringConcat$0(this.owner, this.name, this.descriptor, this.tag, this.isInterface ? " itf" : "");
    }

    private static /* synthetic */ String stringConcat$0(String string, String string2, String string3, int n, String string4) {
        return string + "." + string2 + string3 + " (" + n + string4 + ")";
    }
}
